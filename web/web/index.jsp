            ...
            <c:forEach var="lists" items="${ren_list}">
                <li>
                    ...
                    <div class="cbp_tmlabel" data-scroll-reveal="enter right over 1s">
                        ...
                        <a href="/template?id=${lists.id}" target="_blank" class="readmore">阅读全文&gt;&gt;</a>
                    </div>
                </li>
            </c:forEach>
        </ul>
        <div class="page"><a href="/Page.jsp?type=q&page=${pages_size-1}">上</a><a href="/Page.jsp?type=h&page=${pages_size}">下</a></div>
